...
print(response) 
# <http.client.HTTPResponse object at 0x0000020B9219DBE0>
...
# CCTV 목록이 맨 위에 안 놓여있고, response => data 안에 숨어 있어서 
# 데이터프레임 변환 → 사전(dict)이 중첩되어 깊이 들어가기 번거로움
